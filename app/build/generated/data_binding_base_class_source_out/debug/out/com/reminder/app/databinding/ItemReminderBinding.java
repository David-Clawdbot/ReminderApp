...
public final class ItemReminderBinding implements ViewBinding {
  ...
  private ItemReminderBinding(@NonNull MaterialCardView rootView, @NonNull ImageButton btnDelete,
      @NonNull ImageButton btnEdit, @NonNull SwitchMaterial switchEnabled,
      @NonNull TextView textDescription, @NonNull TextView textRepeat, @NonNull TextView textTime) {
  ...
  public static ItemReminderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReminderBinding((MaterialCardView) rootView, btnDelete, btnEdit, switchEnabled,
          textDescription, textRepeat, textTime);
    }
